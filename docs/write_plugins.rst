...
All kind of plugins inherit from the base :class:`Plugin <pyload.plugins.Base.Plugin>`. You should know its
...
They can access all the methods from :class:`Plugin <pyload.plugins.Base.Plugin>`, but the important thing is they
